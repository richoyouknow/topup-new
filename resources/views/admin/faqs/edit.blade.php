...
<div class="flex flex-col gap-8 max-w-3xl">
    <div>
        <h1 class="text-2xl font-extrabold text-white">Edit FAQ</h1>
        <p class="text-xs text-gray-500 mt-1">Perbarui rincian pertanyaan umum.</p>
    </div>
    ...
    <form action="{{ route('admin.faqs.update', $faq->id) }}" method="POST" class="bg-card-dark border border-border-dark rounded-2xl p-6 sm:p-8 shadow-glow flex flex-col gap-6">
        @csrf
        @method('PUT')
